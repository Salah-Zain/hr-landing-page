      ...
      <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="text-slate-400 hover:text-amber-600 transition-colors" aria-label="Instagram">
              <InstagramIcon className="w-4 h-4" />
            </a>
            <a href="#" className="text-slate-400 hover:text-amber-600 transition-colors" aria-label="LinkedIn">

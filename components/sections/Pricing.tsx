        ...
        <div className="relative bg-white rounded-[3rem] overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.06)] max-w-4xl mx-auto py-16 px-6 md:px-12 text-center border border-slate-200 ring-1 ring-slate-100">
          ...
          <div className="relative z-10">
            <motion.div
              ...
              className="inline-block px-4 py-1.5 rounded-full bg-amber-50 border border-amber-200 text-amber-600 font-bold tracking-wide text-sm mb-6 uppercase"
            >
              Simple Pricing
            </motion.div>
            ...
            >
              One Decision. <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-600">A Career That Pays You Back.</span>
            </motion.h2>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-left w-full">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-5xl md:text-6xl font-black text-slate-900 tracking-tight">₹35,000</span>
                  </div>
                ...
                <div className="w-full md:w-auto flex-shrink-0">
                  <Link href="/schedule">
                    <Button size="lg" className="w-full md:w-auto px-8 h-14 text-lg group hover:scale-105 shadow-md shadow-amber-500/20">
